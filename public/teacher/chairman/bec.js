...
let tableCurriculum = $("#tableCurriculum").DataTable({
    ...
    columns: [
        ...
        },
        {
            data: null,
            render: function (data) {
                return `<button type="button" class="btn btn-sm btn-danger becDelete btnDelete_${data.id}  pt-0 pb-0 pl-2 pr-2" id="${data.id}">
                    Delete
                    </button>&nbsp;
                    <button type="button" class="btn btn-sm btn-info becEdit btnEdit_${data.id} pt-0 pb-0 pl-3 pr-3 " id="${data.id}">
                        Section
                    </button>
                    `;
            },
...
$(document).on("click", ".becDelete", function () {
    let id = $(this).attr("id");
...
$(document).on("click", ".becEdit", function () {
    let id = $(this).attr("id");
